    ...
    <header>
      <div class="brand">
        ...
        <a href="https://t.me/Dark_LordSl">
          <h2 class="name">Dark Lord Mirror</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://telegra.ph/Source-Code-08-05-2"><i class="fab fa-github"></i></a>
...
@app.route('/')
def homepage():
    return "<h1>Full Credits <a href='https://www.github.com/anasty17/mirror-leech-telegram-bot'>@GitHub</a> By <a href='https://github.com/anasty17'>Anas</a></h1>"
